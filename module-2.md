...
Решение
Физический сервер. Так как монолитное - невозможно реализовать в микросерверах без изменения кода, а так как 
высоконагруженное - то желательно не тратить ресурсы на виртуализщацию.
 ```
```TEXT
Сценарий 2
...
Решение
Докер. Можно быстро развертывать приложение со всеми зависимостями.
 ```
```TEXT
Сценарий 3
...
Решение
Виртуальная машина. Масштабирования и частого обновления не требуется, удобно делать бэкапы.
 ```
### Задача 3
